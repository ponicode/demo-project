...
describe("user_importer.add_users_in_bulk", () => {
    test("0", () => {
        expect(user_importer.add_users_in_bulk({ bulk_header: "ponicode123", to_company_id: "user@ponicode" }))
    })

    test("1", () => {
        expect(user_importer.add_users_in_bulk({ bulk_header: "ponicode123", to_company_id: "user1+user2@ponicode.com" }))
    })

    test("2", () => {
        expect(user_importer.add_users_in_bulk({ bulk_header: "ponicode", to_company_id: "user@ponicode" }))
    })

    test("3", () => {
        expect(user_importer.add_users_in_bulk({ bulk_header: "poni_code", to_company_id: "1user@ponicode.com" }))
    })
    ...
    test("7", () => {
        expect(user_importer.add_users_in_bulk({ bulk_header: "ponicode", to_company_id: "user.ponicode.com" }))
    })

    test("8", () => {
        expect(user_importer.add_users_in_bulk({ bulk_header: "poni-code", to_company_id: "user.ponicode.com" }))
    })

    test("9", () => {
        expect(user_importer.add_users_in_bulk({ bulk_header: "poni&code", to_company_id: "ponicode.com" }))
    })

    test("10", () => {
        expect(user_importer.add_users_in_bulk({ bulk_header: "ponicode123", to_company_id: "1user@ponicode.com" }))
    })
})
